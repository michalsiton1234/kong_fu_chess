...
from paths import LOGIC_DIR, ensure_working_directory
...
from bridge.match_recorder import MatchRecorder
from bridge.snapshot_builder import SnapshotBuilder
from input.mouse_adapter import MouseAdapter
from view.board_layout import BOARD_OFFSET_X, cell_bounds
from view.graphics_board_mapper import GraphicsBoardMapper
from view.piece_assets import BOARD_PNG
from view.renderer import Renderer
from view.window_fit import fit_display_scale
...
def main() -> None:
    ...
    engine.add_observer(match_recorder)
